...
import com.cactusknights.chefbook.fragments.CustomRecipesFragment
...
//            } else {
//                activity?.showToast(R.string.recipes_limit)
...
//                recipes.addAll(viewModel.getRecipes() as Collection<Recipe>)
    ...
    override fun onStart() {
        lifecycleScope.launch {
            viewModel.recipes.collect { newRecipes: List<Recipe> ->
