package com.cactusknights.chefbook.ui.views.bottomsheet
...
@Stable
class AnimatedBottomSheetState(
    ...
    BoxWithConstraints(
        modifier = modifier
            .onGloballyPositioned { coordinates ->
                val targetValue = with(density) { coordinates.size.height.toDp() - com.cactusknights.chefbook.ui.screens.home.views.tabsHeight }
