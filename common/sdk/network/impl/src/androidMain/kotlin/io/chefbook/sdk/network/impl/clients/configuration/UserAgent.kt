...
internal fun UserAgentConfig.configureAndroidAgent(context: Context) {
  ...
  agent =
    "ChefBook/$version (Linux; U; Android $androidVersion; $languageCode; $model; Build/$buildNumber)"
}
