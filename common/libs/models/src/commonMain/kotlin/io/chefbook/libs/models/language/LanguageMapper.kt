...
object LanguageMapper {
  ...
  private val languageMap = mapOf(
    ...
    Language.KAZAKH.code to Language.KAZAKH,
    Language.ARMENIAN.code to Language.ARMENIAN,
    Language.GEORGIAN.code to Language.GEORGIAN,
    Language.SERBIAN.code to Language.SERBIAN,
