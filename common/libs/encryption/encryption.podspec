Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/encryption.framework') || Dir.empty?('build/cocoapods/framework/encryption.framework')
        ...
        Kotlin framework 'encryption' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :common:libs:encryption:generateDummyFramework

        Alternatively, proper pod installation is performed during Gradle sync in the IDE (if Podfile location is set)"
    end
                
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':common:libs:encryption',
        'PRODUCT_MODULE_NAME' => 'encryption',
    }
