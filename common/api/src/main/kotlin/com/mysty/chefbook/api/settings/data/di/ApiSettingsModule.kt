...
import com.mysty.chefbook.api.settings.domain.usecases.GetDefaultRecipeLanguageUseCase
...
val apiSettingsModule = module {
    ...
    factoryOf(::GetDefaultRecipeLanguageUseCase) bind IGetDefaultRecipeLanguageUseCase::class
