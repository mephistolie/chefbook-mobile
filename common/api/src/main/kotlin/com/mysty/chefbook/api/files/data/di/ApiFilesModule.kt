...
import com.mysty.chefbook.api.files.domain.usecases.CompressImageUseCase
...
val apiFilesModule = module {
    ...
    singleOf(::LocalFileSource) { named(Qualifiers.LOCAL) } bind ILocalFileSource::class
    ...
    factoryOf(::CompressImageUseCase) bind ICompressImageUseCase::class
