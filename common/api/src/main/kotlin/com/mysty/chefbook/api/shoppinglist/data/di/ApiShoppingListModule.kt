...
import com.mysty.chefbook.api.shoppinglist.domain.usecases.CreatePurchaseUseCase
...
import com.mysty.chefbook.api.shoppinglist.domain.usecases.UpdatePurchaseUseCase
...
val apiShoppingListModule = module {
    ...
    factoryOf(::CreatePurchaseUseCase) bind ICreatePurchaseUseCase::class
    factoryOf(::UpdatePurchaseUseCase) bind IUpdatePurchaseUseCase::class
