package io.chefbook.utils.android.qr
...
/**
 * Ported from Java to Kotlin and changed for app purposes
 */
...
class QRCodeWriter(
  ...
  fun getGradientQrCode(
    ...
    val qrBitmap = encode(data, qrBitmapSize, null, backgroundColor, startColor)
